...
public void OnPluginStart()
{
	...
	// ConVars
	g_hCvarGlobalPercent = CreateConVar("l4d_global_percent", "1", "使用命令时向整个团队显示boss百分比");	  // Sets if Percents will be displayed to entire team when boss percentage command is used
	g_hCvarTankPercent	 = CreateConVar("l4d_tank_percent", "1", "在聊天中显示tank流量百分比");							  // Sets if Tank Percents will be displayed on ready-up and when boss percentage command is used
	g_hCvarWitchPercent	 = CreateConVar("l4d_witch_percent", "1", "在聊天中显示witch流量百分比");							  // Sets if Witch Percents will be displayed on ready-up and when boss percentage command is used
