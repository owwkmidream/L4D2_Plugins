...
public Plugin myinfo =
{
	...
	version		= "2.4.1",
	description = "设置一个坦克刷新点，并可以选择在每张地图上删除女巫生成点",
...
public void OnPluginStart()
{
	...
	g_hCvarWitchAvoidTank = CreateConVar("sm_witch_avoid_tank_spawn", "0", "Minimum flow amount witches should avoid tank spawns by, by half the value given on either side of the tank spawn", FCVAR_NOTIFY, true, 0.0, true, 100.0);
